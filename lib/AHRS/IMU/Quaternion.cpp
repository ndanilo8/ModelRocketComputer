...
/*
Work from https://github.com/peregrine-developments/Orientation
addapted by Danilo Nascimento
...
{
    // Axis-angle representation to rotation quaternion
    float sa = sin(angle / 2);

    // https://en.wikipedia.org/wiki/Quaternions_and_spatial_rotation 
    // rotation of angle {\displaystyle \theta }\theta  around the axis defined by the unit vector
    Quaternion ret;
    ret.a = cos(angle / 2);
    ret.b = x * sa;
    ret.c = y * sa;
